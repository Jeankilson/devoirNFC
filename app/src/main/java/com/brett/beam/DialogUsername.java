...
public class DialogUsername extends DialogFragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        getDialog().setTitle(getResources().getString(R.string.msg_setUsername));
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.dialog_btn_ok){
            ...
            if (username.length() >= 2){
                ...
                edt_username.setError(getResources().getString(R.string.usernamenotvalid));
            }
